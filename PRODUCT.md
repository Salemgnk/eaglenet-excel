...
- The four originally-placeholder modules (Stock, Ventes, Achats, Employés) are all built now. The Excel push worker is the one remaining not-yet-built item.
