...
- Planned, not yet built: Employés/paie — visible in the dashboard's navigation as a disabled placeholder, to be scoped and built as its own sub-project. The Excel push worker is also not yet built.
